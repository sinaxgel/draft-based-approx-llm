...
LOG=/home/ubuntu/zhangpengcheng/logs/vlm-specpc-fusion-pilot.log
STATUS=/home/ubuntu/zhangpengcheng/logs/vlm-specpc-fusion-pilot.status
OUTPUT=/home/ubuntu/zhangpengcheng/outputs/vlm-specpc-fusion-pilot/results.json

mkdir -p /home/ubuntu/zhangpengcheng/logs /home/ubuntu/zhangpengcheng/outputs/vlm-specpc-fusion-pilot /home/ubuntu/zhangpengcheng/cache/huggingface /home/ubuntu/zhangpengcheng/cache/torch_extensions
...
/home/ubuntu/miniconda3/bin/conda run --no-capture-output -n zpc-spec python scripts/vlm_specpc_fusion_pilot.py --resume --output "${OUTPUT}" 2>&1 | tee "${LOG}"
code=${PIPESTATUS[0]}
