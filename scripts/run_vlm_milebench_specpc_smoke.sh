...
LOG=/home/ubuntu/zhangpengcheng/logs/milebench-specpc-smoke.log
STATUS=/home/ubuntu/zhangpengcheng/logs/milebench-specpc-smoke.status

mkdir -p \
    /home/ubuntu/zhangpengcheng/logs \
    /home/ubuntu/zhangpengcheng/outputs/milebench-specpc-smoke \
...
/home/ubuntu/miniconda3/bin/conda run --no-capture-output -n zpc-spec \
    python scripts/vlm_milebench_specpc_smoke.py 2>&1 | tee "${LOG}"
code=${PIPESTATUS[0]}
