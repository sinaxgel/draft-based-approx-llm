...
LOG=/home/ubuntu/zhangpengcheng/logs/vlm-specpc-smoke.log
STATUS=/home/ubuntu/zhangpengcheng/logs/vlm-specpc-smoke.status

mkdir -p \
    /home/ubuntu/zhangpengcheng/logs \
    /home/ubuntu/zhangpengcheng/outputs/vlm-specpc-smoke/heatmaps \
...
/home/ubuntu/miniconda3/bin/conda run --no-capture-output -n zpc-spec \
    python scripts/vlm_specpc_smoke.py 2>&1 | tee "${LOG}"
code=${PIPESTATUS[0]}
